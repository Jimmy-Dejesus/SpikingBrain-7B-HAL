...
from .window_attention import FlashAttention
...
class GLU(nn.Module):
    ...
    def __init__(
        ...
        self.gate_proj = QuantLinear(self.hidden_size, self.intermediate_size, bias=False)
        self.up_proj = QuantLinear(self.hidden_size, self.intermediate_size, bias=False)
        self.down_proj = QuantLinear(self.intermediate_size, self.hidden_size, bias=False)
...
class HybridModel(HybridPreTrainedModel):
    ...
    def __init__(self, config: GLAswaConfig):
        ...
        self.num_meta_tokens = 0
        self.use_lower_bound = False
